export default {
  ...
  formProduct: {
    ...
    nameProductRequired: 'Укажите название товара',
    nameProductMinLength: 'Название должно содержать не менее 3 символов',
    nameProductPlaceholder: 'Введите название',
    price: 'Цена',
    priceRequired: 'Укажите цену',
    priceNegative: 'Цена не может быть отрицательной',
    sections: 'Разделы',
    sectionsRequired: 'Выберите хотя бы один раздел',
